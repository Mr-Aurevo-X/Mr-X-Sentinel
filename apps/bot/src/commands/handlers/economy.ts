...
import { renderEcoTab, runEconomyReward, type EconomyRewardAction } from "../../services/EconomyActions.js";
...
export async function handleBuy(interaction: ChatInputCommandInteraction): Promise<CommandReply> {
...
export async function handleEco(interaction: ChatInputCommandInteraction): Promise<CommandReply> {
  const member = interaction.member as GuildMember;
  return renderEcoTab("home", member, interaction.guild!.id);
}
